...
//         <button className="flex items-center bg-white text-black font-bold py-2 px-6 rounded hover:bg-gray-300 transition duration-300">
//           <FaPlay className="mr-2" /> Play
//         </button>
//         <button className="flex items-center bg-gray-700 bg-opacity-75 text-white font-bold py-2 px-6 rounded hover:bg-gray-600 transition duration-300">
